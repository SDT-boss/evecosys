/**
 * Design System primitive: AlertDialog
 *
 * Blocking confirmation modal for irreversible or high-risk actions.
 * Unlike Dialog, AlertDialog cannot be dismissed by clicking the overlay —
 * the user must explicitly confirm or cancel.
 *
 * Use for:
 *   - Deleting a driver account
 *   - Removing a vehicle from a fleet
 *   - Revoking a Manager's access
 *   - Any action with consequences that cannot be undone
 *
 * Action button: destructive Button variant (red bg) by default.
 * Cancel button: outline Button variant.
 * Both use the ds-* Button primitive for full state coverage.
 *
 * Sub-components: AlertDialog, AlertDialogTrigger, AlertDialogContent,
